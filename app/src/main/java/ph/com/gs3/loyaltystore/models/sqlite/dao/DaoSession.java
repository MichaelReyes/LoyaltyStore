...
public class DaoSession extends AbstractDaoSession {
    ...
    private final DaoConfig productBreakdownDaoConfig;
    ...
    private final DaoConfig productForDeliveryDaoConfig;

    private final ProductDao productDao;
    private final ProductBreakdownDao productBreakdownDao;
    ...
    private final ProductForDeliveryDao productForDeliveryDao;
    ...
    public DaoSession(SQLiteDatabase db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        productBreakdownDaoConfig = daoConfigMap.get(ProductBreakdownDao.class).clone();
        productBreakdownDaoConfig.initIdentityScope(type);
        ...
        itemInventoryDaoConfig = daoConfigMap.get(ItemInventoryDao.class).clone();
        itemInventoryDaoConfig.initIdentityScope(type);

        itemStockCountDaoConfig = daoConfigMap.get(ItemStockCountDao.class).clone();
        itemStockCountDaoConfig.initIdentityScope(type);

        productForDeliveryDaoConfig = daoConfigMap.get(ProductForDeliveryDao.class).clone();
        productForDeliveryDaoConfig.initIdentityScope(type);

        productDao = new ProductDao(productDaoConfig, this);
        productBreakdownDao = new ProductBreakdownDao(productBreakdownDaoConfig, this);
        ...
        productForDeliveryDao = new ProductForDeliveryDao(productForDeliveryDaoConfig, this);

        registerDao(Product.class, productDao);
        registerDao(ProductBreakdown.class, productBreakdownDao);
        ...
        registerDao(ProductForDelivery.class, productForDeliveryDao);
    }
    
    public void clear() {
        productDaoConfig.getIdentityScope().clear();
        productBreakdownDaoConfig.getIdentityScope().clear();
        ...
        productForDeliveryDaoConfig.getIdentityScope().clear();
    }
    ...
    public ProductBreakdownDao getProductBreakdownDao() {
        return productBreakdownDao;
    }
    ...
    public ItemStockCountDao getItemStockCountDao() {
        return itemStockCountDao;
    }

    public ProductForDeliveryDao getProductForDeliveryDao() {
        return productForDeliveryDao;
    }
