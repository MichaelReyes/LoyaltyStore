 ...
 */
public class CustomerDeviceListAdapter extends BaseAdapter {

    private Context context;
    private List<WifiP2pDevice> customerDeviceList;

    public CustomerDeviceListAdapter(Context context, List<WifiP2pDevice> customerDeviceList) {
    ...
    @Override
    public int getCount() {
        return customerDeviceList.size();
    }

    @Override
    public Object getItem(int position) {
        return customerDeviceList.get(position);
    }
...
//            deviceInfo = DeviceInfo.unserialize(customerDevice.secondaryDeviceType);
        ...
        if (row == null) {
            ...
            row = inflater.inflate(R.layout.view_customer_device, parent, false);
    ...
    private static class CustomerDeviceViewHolder {
        ...
        public CustomerDeviceViewHolder(View view) {
            ...
            tvDisplayName = (TextView) view.findViewById(R.id.Customer_tvDisplayName);
            tvDeviceAddress = (TextView) view.findViewById(R.id.Customer_tvDeviceAddress);
